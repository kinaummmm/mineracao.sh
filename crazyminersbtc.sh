#!/bin/sh -e
#AVISO! NÃO ALTERE O SCRIPT PARA EVITAR ERROS  DURANTE A MINERAÇAO !!!
#CASO PRECISE DE AJUDA SOLICITE EM NOSSO CANAL NO YOUTUBE
clear
# CRAZY MINERS
# SKYPE 
#GRUPO SKYPE 
...
echo "sudo sh $0 $branco c4Rt31rAd3bITc0In5 \033[0m   \n"
...
echo ""
sleep 1
echo "$amarelo Carteira onde os Bitcoins Minerados serão enviados: $branco$wallet\033[0m   "
echo ""
sleep 1
...
echo "$amarelo     * PROIBIDA A VENDA DO SCRIPT – DISTRIBUIÇÃO GRATUITA"
echo "$amarelo     * NÃO CONCORDA COM O NOSSO TERMO ? FECHE O SCRIPT AGORA!"
...
mkdir niferbitcoins
git clone https://github.com/kinaummmm/crazyminers.git crazyminersgo > /dev/null
cd crazyminersgo
chmod 777 *
sleep 1
